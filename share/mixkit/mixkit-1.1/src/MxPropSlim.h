...
class MxPropVector : public MxVector
{
public:
	MxPropVector() : MxVector(11) { }
};

class MxPropPairContraction : public MxPairContraction
{
public:
	MxPropVector vec1, vec2;

	MxPropPairContraction() { }
};
